...
if (SERVER) then
	function ENT:Initialize()
		self:SetModel("models/se_ex/green_box.mdl")
	...
	function ENT:OnPopulateEntityInfo(tooltip)
		...
		description:SetText("Twoja bezpieczna skrytka na przedmioty, nikt inny nie ma do niej dostępu.")

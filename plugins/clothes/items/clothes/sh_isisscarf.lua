ITEM.name = "Szal terrorysty"
ITEM.description = "Szal z ekstremistycznym napisem."
...
ITEM.model = "models/shtokerbox/ground_headgear_arab4.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.iconCam = {
		...
		["children"] = {
			[1] = {
				...
				["self"] = {
                    ...
                    ["Bone"] = "head",
                    ["BoneMerge"] = true,
					["Model"] = "models/shtokerbox/headgear/male_headwear_arab4.mdl",

ITEM.name = "Czapka oficerska"
ITEM.description = "Czapka z kompletu galowego rosyjskiego oficera."
...
ITEM.model = "models/shtokerbox/ground_headgear_rus_officer.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.iconCam = {
		...
		["children"] = {
			[1] = {
				...
				["self"] = {
                    ...
                    ["Bone"] = "head",
                    ["BoneMerge"] = true,
					["Model"] = "models/shtokerbox/headgear/male_headwear_rus_officer.mdl",

ITEM.name = "Hełm ALTYN bez osłony"
...
ITEM.damageReduction = { [HITGROUP_HEAD] = 0.5 }
ITEM.rarity = { weight = 1 }

ITEM.price = 20000

ITEM.model = "models/shtokerbox/ground_headgear_atlyn_novisor.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.iconCam = {
		...
		["children"] = {
			[1] = {
				...
				["self"] = {
					...
					["UniqueID"] = "4eeab4e5asd78434914441326f6dea3e835fc2f88b8cebe7f995ca56de477b43",
					["ClassName"] = "model2",
					["Size"] = 1,
					["EditorExpand"] = true,
                    ["Bone"] = "head",
                    ["BoneMerge"] = true,
					["Model"] = "models/shtokerbox/headgear/male_headwear_atlyn_novisor.mdl",

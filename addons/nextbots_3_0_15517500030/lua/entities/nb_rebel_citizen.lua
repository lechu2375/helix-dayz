...
--Kill Feed
if CLIENT then
	language.Add("nb_rebel_citizen", "Armed Citizen")
end
...
--Spawnmenu--
list.Set( "sean_nextbots", "nb_rebel_citizen", 	
{	Name = "Armed Citizen", 
	Class = "nb_rebel_citizen",
	Category = "Rebels"	
})
...
ENT.WalkAnim = ACT_HL2MP_WALK_SHOTGUN  
...
function ENT:SetWeaponType( wep )
	...
	if wep == "wep_nb_smg" then
		...
		self.WalkAnim = ACT_HL2MP_WALK_SMG1
	...
	elseif wep == "wep_nb_shotgun" then
		...
		self.WalkAnim = ACT_HL2MP_WALK_SHOTGUN
	...
	elseif wep == "wep_nb_revolver" then
		...
		self.WalkAnim = ACT_HL2MP_WALK_REVOLVER
	...
	elseif wep == "wep_nb_pistol" then
		...
		self.WalkAnim = ACT_HL2MP_WALK_PISTOL

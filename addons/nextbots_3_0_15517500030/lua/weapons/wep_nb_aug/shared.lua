--STATS For NEXTBOT--
sound.Add({
	name = 	"sean_wepnb_sound_aug", --Use this as the string for self.WeaponSound in nextbot
	channel = CHAN_WEAPON,
	...
	sound = {"fas2/aug/aug_fire1.wav"}
})

SWEP.WorldModel = "models/weapons/css_nextbot_3.0/w_rif_aug.mdl"

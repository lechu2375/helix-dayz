--STATS For NEXTBOT--
sound.Add({
	name = 	"sean_wepnb_sound_usps", --Use this as the string for self.WeaponSound in nextbot
	channel = CHAN_WEAPON,
...
SWEP.WorldModel = "models/weapons/css_nextbot_3.0/w_pist_usp_silencer.mdl"

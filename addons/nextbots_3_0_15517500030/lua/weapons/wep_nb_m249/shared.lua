--STATS For NEXTBOT--
sound.Add({
	name = 	"sean_wepnb_sound_m249", --Use this as the string for self.WeaponSound in nextbot
	channel = CHAN_WEAPON,
	...
	sound = {"weapons/tfa_csgo/m249/m249-1.wav"}
})

SWEP.WorldModel = "models/weapons/css_nextbot_3.0/w_mach_m249para.mdl"

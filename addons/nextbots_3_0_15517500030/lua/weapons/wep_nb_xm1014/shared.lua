--STATS For NEXTBOT--
sound.Add({
	name = 	"sean_wepnb_sound_xm1014", --Use this as the string for self.WeaponSound in nextbot
	channel = CHAN_WEAPON,
	...
	sound = {"weapons/tfa_csgo/xm1014/xm1014-1.wav"}
})

SWEP.WorldModel = "models/weapons/css_nextbot_3.0/w_shot_xm1014.mdl"
SWEP.TypeClass = "shotgun"
SWEP.WeaponType = 1

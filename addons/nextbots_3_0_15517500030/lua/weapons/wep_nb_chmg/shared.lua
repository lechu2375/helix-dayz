--STATS For NEXTBOT--
sound.Add({
	name = 	"sean_wepnb_sound_chmg", --Use this as the string for self.WeaponSound in nextbot
	channel = CHAN_WEAPON,
	...
	pitch = {95,100}, --Can be put into table with only a minimum/maximum value {1,100}

--STATS For NEXTBOT--
sound.Add({
	name = 	"sean_wepnb_sound_mac10", --Use this as the string for self.WeaponSound in nextbot
	channel = CHAN_WEAPON,
	...
	sound = {"weapons/tfa_csgo/mac10/mac10-1.wav"}
})

SWEP.WorldModel = "models/weapons/css_nextbot_3.0/w_smg_mac10.mdl"
SWEP.TypeClass = "smg"
SWEP.WeaponType = 1

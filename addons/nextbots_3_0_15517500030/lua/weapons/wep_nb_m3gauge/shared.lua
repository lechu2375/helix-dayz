--STATS For NEXTBOT--
sound.Add({
	name = 	"sean_wepnb_sound_m3gauge", --Use this as the string for self.WeaponSound in nextbot
	channel = CHAN_WEAPON,
...
SWEP.WorldModel = "models/weapons/css_nextbot_3.0/w_shot_m3super90.mdl"

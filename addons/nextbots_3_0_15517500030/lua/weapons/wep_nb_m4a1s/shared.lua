--STATS For NEXTBOT--
sound.Add({
	name = 	"sean_wepnb_sound_m4a1s", --Use this as the string for self.WeaponSound in nextbot
	channel = CHAN_WEAPON,
...
SWEP.WorldModel = "models/weapons/css_nextbot_3.0/w_rif_m4a1_silencer.mdl"

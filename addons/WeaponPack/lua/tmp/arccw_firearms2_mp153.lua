...
SWEP.ShootSoundSilenced = "Firearms2_MP153_S"
...
SWEP.Attachments = {
    ...
    {
        PrintName = "Tube",
        DefaultAttName = "MP-153 4rnd Tube",
        Slot = "fas2_mp153_tube",
    },
    {
...
SWEP.Animations = {
    ...
    ["sgreload_insert"] = {
        ...
        TPAnim = ACT_HL2MP_GESTURE_RELOAD_SHOTGUN,
        SoundTable = {
            {s = "Firearms2.MP153_Insert", t = 0.15},
            {s = "Firearms2.Cloth_Movement", t = 0.15}
            },
    },
    ["sgreload_finish"] = {
        Source = "end",

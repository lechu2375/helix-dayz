...
SWEP.Attachments = {
    ...
    {
        PrintName = "Muzzle",
        Slot = {"fas2_muzzle", "fas2_muzzlebrake", "fas2_flashhider", "fas2_bayonet", "fas2_sks_nade"},
    },
    {
        PrintName = "Magazine",
        DefaultAttName = "SKS 10rnd Mag",
        Slot = "fas2_sks_mags"
    },
	{
...
SWEP.Hook_TranslateAnimation = function(wep, anim)
	local nade = wep.Attachments[2].Installed  == "fas2_muzzle_sks_nade" and "_r" or ""
...
SWEP.Hook_SelectReloadAnimation = function(wep, anim)
    local nomen = wep.Attachments[5].Installed and "_nmc" or ""

	if wep.Attachments[2].Installed == "fas2_muzzle_sks_nade" then
		anim = anim .. "_r"
	end
...
SWEP.Animations = {
	...
	["reload_empty_r"] = {
		...
		{s = "Firearms2.SKS_ClipIn", t = 1.4},
		{s = "Firearms2.Cloth_Movement", t = 1.4},
		{s = "Firearms2.SKS_BoltRelease", t = 2},
		{s = "Firearms2.Cloth_Movement", t = 2},
		{s = "Firearms2.SKS_BoltForward", t = 2.2},
		{s = "Firearms2.Cloth_Movement", t = 2.2},
		{s = "Firearms2.Holster", t = 2.63},
		{s = "Firearms2.M24_Butt", t = 3},
        {s = "Firearms2.M24_Butt", t = 3.35},
		{s = "Firearms2.Deploy", t = 3.5},
		},
    },
	["reload_empty_r_20"] = {
        Source = "Reload_r_empty",
	...
	["reload_empty_r_nmc"] = {
		...
		{s = "Firearms2.SKS_ClipIn", t = 1.05},
		{s = "Firearms2.Cloth_Movement", t = 1.05},
		{s = "Firearms2.SKS_BoltRelease", t = 1.5},
		{s = "Firearms2.Cloth_Movement", t = 1.5},
		{s = "Firearms2.SKS_BoltForward", t = 1.65},
		{s = "Firearms2.Cloth_Movement", t = 1.65},
		{s = "Firearms2.Holster", t = 1.97},
		{s = "Firearms2.M24_Butt", t = 2.25},
        {s = "Firearms2.M24_Butt", t = 2.45},
		{s = "Firearms2.Deploy", t = 2.625},
		},
    },
	["reload_empty_r_20_nmc"] = {
        Source = "Reload_r_empty",
        Time = 120/40,
        TPAnim = ACT_HL2MP_GESTURE_RELOAD_AR2,
		SoundTable = {
	...
	["idle_r"] = {
        Source = "idle_r_scoped",
        Time = 0/1,
    },
	["idle_empty_r"] = {
        Source = "idle_r_empty_scoped",
        Time = 0/1,
...
function SWEP:FireRocket(ent, vel, ang)
    ...
    src = src + EA:Right() * 2 - EA:Up() * 2 + EA:Forward() * 8

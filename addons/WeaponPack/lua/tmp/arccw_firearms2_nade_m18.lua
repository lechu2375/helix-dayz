...
SWEP.Primary.Ammo = "m18_nades"

SWEP.MuzzleVelocity = 1150
SWEP.ShootEntity = "arccw_firearms2_thrown_m18"
...
SWEP.CustomizePos = Vector(8.824, -2, -1.697)
...
function SWEP:FireRocket(ent, vel, ang)
    ...
    src = src + EA:Right() * 3 - EA:Up() * -2 + EA:Forward() * 8

...
SWEP.Primary.Ammo = "m67_nades"

SWEP.MuzzleVelocity = 1150
SWEP.ShootEntity = "arccw_firearms2_thrown_m67"
...
SWEP.CustomizePos = Vector(8.824, -2, -2.897)
...
--     self:GetOwner():SetAmmo(self:Ammo1() - 20, self.Primary.Ammo)
-- end

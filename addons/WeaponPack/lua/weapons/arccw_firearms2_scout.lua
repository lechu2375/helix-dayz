...
SWEP.Trivia_Country = "	Steyr Mannlicher"
SWEP.Trivia_Year = "1990"

SWEP.UseHands = false

SWEP.ViewModel = "models/weapons/fas2/view/snipers/scout.mdl"
SWEP.WorldModel = "models/weapons/fas2/world/snipers/scout.mdl"
...
SWEP.ShootSound = "Firearms2_SCOUT"
...
SWEP.ShootSoundSilenced = "Firearms2_SCOUT_S"
...
SWEP.Attachments = {
    {
        ...
        Bone = "Dummy04",
        Offset = {
            vpos = Vector(-2, -1.02, -0.01),
            vang = Angle(0, 0, 270),
            wpos = Vector(9.85, 0.81, -5.55),
            wang = Angle(-10.393, 0, 180)
        },
        WMScale = Vector(1.6, 1.6, 1.6),
        CorrectivePos = Vector(-0.0085, -1, 0.009),
    },
    {
        PrintName = "Muzzle",
    ...
    },
    {
        ...
        Bone = "Dummy04",
        Offset = {
            vpos = Vector(1, -1.02, -0.01),
            vang = Angle(0, 0, 270),
            wpos = Vector(15.2, 0.81, -6.45),
            wang = Angle(-10.393, 0, 180)
        },
        WMScale = Vector(1.6, 1.6, 1.6),
    },
    {
        ...
        Bone = "Dummy04",
        Offset = {
            vpos = Vector(4, -1.02, -0.01),
            vang = Angle(0, 0, 270),
            wpos = Vector(21, 0.81, -7.5),
            wang = Angle(-10.393, 0, 180)
        },
        WMScale = Vector(1.6, 1.6, 1.6),
    },

...
SWEP.Hook_SelectReloadAnimation = function(wep, anim)
    ...
    local mag34 = wep.Attachments[2].Installed and "_34rnd" or ""

	return "reload" .. mag34 .. empty .. nomen
end
...
SWEP.Animations = {
    ...
    ["reload_34rnd_empty_nomen"] = {
        Source = "reload_34rnd_empty_nomen",
        Time = 89/37.5,
        TPAnim = ACT_HL2MP_GESTURE_RELOAD_PISTOL,
		SoundTable = {
        {s = "Firearms2.Cloth_Movement", t = 0},

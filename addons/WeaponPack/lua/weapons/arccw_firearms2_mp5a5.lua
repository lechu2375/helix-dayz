...
SWEP.Attachments = {
    ...
    {
        PrintName = "Handguard",
        DefaultAttName = "MP5A5 Handguard",
        Slot = {"fas2_mp5a5_grip", "fas2_mp5a5_light"},
        Bone = "Dummy01",
        Offset = {
            vpos = Vector(7, 0.8, 0),
            vang = Angle(0, 0, 270),
...
SWEP.Hook_TranslateAnimation = function(wep, anim)
    if wep.Attachments[3].Installed == "fas2_handguard_mp5_grip" then return anim .. "_grip" end
end
...
SWEP.Hook_SelectReloadAnimation = function(wep, anim)
    ...
    local grip = wep.Attachments[3].Installed == "fas2_handguard_mp5_grip" and "_grip" or ""
...
SWEP.Animations = {
    ...
    ["reload_empty"] = {
		...
		{s = "Firearms2.MP5_BoltForward", t = 2.95},
		{s = "Firearms2.Cloth_Movement", t = 2.95},
		},
    },
    ["reload_nomen"] = {
        Source = "reload_nomen",
    ...
    ["reload_nomen_empty"] = {
		...
		{s = "Firearms2.MP5_BoltPull", t = 1.8},

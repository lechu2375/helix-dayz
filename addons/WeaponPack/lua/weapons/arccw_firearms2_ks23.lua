...
SWEP.Primary.Ammo = "23x75mm" -- what ammo type the gun uses
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        DefaultAttName = "23x75MM",
        Slot = {"fas2_ammo_23x75mms25", "fas2_ammo_23x75mmzvezda"},
    },
    {
        PrintName = "Skill",
...
SWEP.Hook_SelectReloadAnimation = function(wep, anim)
    if wep.Attachments[3].Installed then return anim .. "_nomen" end
end

SWEP.Hook_SelectInsertAnimation = function(wep, anim)
    local nomen = wep.Attachments[3].Installed and "_nomen" or ""

...
SWEP.Penetration = 20
SWEP.ShootEntity = "arccw_firearms2_rpg26rocket_fly" -- entity to fire, if any
...
SWEP.Primary.Ammo = "rpg26_rocket" -- what ammo type the gun uses
...
SWEP.Hook_PostFireBullets = function(wep)
    ...
    if ply:IsPlayer() then
        ...
        dir.z = 0
        dir:Normalize()
        ply:SetVelocity(dir * (ply:IsOnGround() and -500 or -300))
    end

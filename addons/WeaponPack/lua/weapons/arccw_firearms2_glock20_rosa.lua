...
SWEP.Attachments = {
    {
        ...
        Bone = "glock_main",
        Offset = {
            vpos = Vector(0, 1.8, 1.02),
            vang = Angle(0, 270, 0),
            wpos = Vector(7.2, 0.79, -4.37),
    ...
    },
    {
        ...
        Bone = "glock_main",
        Offset = {
            vpos = Vector(0, 2.1, -0.7),
            vang = Angle(0, 270, 0),
            wpos = Vector(8.2, 0.79, -1.55),
            wang = Angle(-10.393, 0, 180),
        },
        WMScale = Vector(1.6, 1.6, 1.6),
    },
    {
        PrintName = "Magazine",
        DefaultAttName = "Glock-20 15rnd Mag",
        Slot = "fas2_glock20_33rnd",
    },
    {
...
SWEP.Hook_SelectReloadAnimation = function(wep, anim)
    ...
    local mag33 = wep.Attachments[4].Installed and "_33rnd" or ""

	return anim .. mag33 .. nomen
end
...
SWEP.Animations = {
    ...
    ["reload_empty_33rnd_nomen"] = {
        Source = "reload_33rnd_empty_nomen",
        Time = 96/37,
        TPAnim = ACT_HL2MP_GESTURE_RELOAD_PISTOL,
		SoundTable = {
		{s = "Firearms2.Cloth_Movement", t = 0},

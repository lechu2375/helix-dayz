...
-- Misc --
ENT.PrintName = "CDF Recruit"
ENT.Category = "DayZ"
ENT.Models = {
  	"models/easterncrisis/reinforcements/chernarus_infantry.mdl",
	"models/easterncrisis/reinforcements/chernarus_infantry_mask.mdl"
}
...
if SERVER then
    ...
    function ENT:CustomInitialize()
		local weptab = {
			"arccw_firearms2_g3",
            "arccw_firearms2_mac11",
            "arccw_firearms2_pm",
            "arccw_firearms2_sks",
            "arccw_firearms2_stenmk2",
            "arccw_firearms2_sterling_l2a3",
            "arccw_firearms2_sterling_mk7a4",
			"arccw_firearms2_aks74u",
	...
	function ENT:OnTakeDamage(dmg)
		...
		self:AlertAllies(dmg:GetAttacker(), true)

...
-- Misc --
ENT.PrintName = "Weak Bandit"
ENT.Category = "DayZ"
ENT.Models = {
  	"models/gmodz/npc/bandit_exp.mdl"
}
...
ENT.OnDeathSounds = {"gmodz/npc/bandit/death_1.ogg","gmodz/npc/bandit/death_2.ogg","gmodz/npc/bandit/death_3.ogg","gmodz/npc/bandit/death_4.ogg","gmodz/npc/bandit/death_5.ogg"}

ENT.OnDamageSounds = {"gmodz/npc/bandit/hit_1.ogg","gmodz/npc/bandit/hit_2.ogg","gmodz/npc/bandit/hit_3.ogg","gmodz/npc/bandit/hit_4.ogg","gmodz/npc/bandit/hit_5.ogg","gmodz/npc/bandit/hit_6.ogg"}
...
if SERVER then
    ...
    function ENT:CustomInitialize()
		local weptab = {
			...
			"arccw_firearms2_bm16",
            "arccw_firearms2_kar98k",
		}
		self:GiveWeapon(weptab[math.random(1,#weptab)])
		if(self:GetActiveWeapon():GetClass()=="arccw_firearms2_kar98k") then
			self.WeaponAccuracy = 0.15
		end
		...
		self:SetFactionRelationship("FACTION_BANDITS", D_LI, 99)
		self:SetFactionRelationship("FACTION_CIVIL", D_HT, 50)
		self:SetFactionRelationship("FACTION_CDF", D_HT, 99)
    end
	...
	function ENT:VoiceLine(type)
		...
		if type == "idle" then
			sounds = 'gmodz/npc/bandit/idle_'..math.random(1,35)..'.ogg'
		elseif type == "combat" then
			local rnd = math.random(1,2)
			if rnd == 1 then
				sounds = 'gmodz/npc/bandit/detour_'..math.random(1,10)..'.ogg'
            else 
				sounds = 'gmodz/npc/bandit/help_'..math.random(1,7)..'.ogg'
			end
		elseif type == "killed" then
			sounds = 'gmodz/npc/bandit/tolls_'..math.random(1,5)..'.ogg'
		elseif type == "reload" then
			sounds = ""
		elseif type == "grenade" then
			sounds = 'gmodz/npc/bandit/grenade_'..math.random(1,3)..'.ogg'
		elseif type == "follow" then
			sounds = 'gmodz/npc/bandit/search_'..math.random(1,5)..'.ogg'
		end

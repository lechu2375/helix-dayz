...
-- Misc --
ENT.PrintName = "BWACC Riot"
ENT.Category = "BlackWatch Army"
ENT.Models = {
  	"models/blackwatcharmy_nextbots/bwacc_riot_ragdoll.mdl"
}
...
if SERVER then
    ...
    function ENT:CustomInitialize()
		...
		self:GiveWeapon(wep)
		self.AvoidEnemyRange = 300
		self.AvoidAfraidOfRange = 400
      	self:SetDefaultRelationship(D_HT)
		if GetConVar("bwa_friends"):GetBool() then
			self:AddRelationship("player D_LI 99")
		end
      	self:SetHealth(math.random(175,200))
      	self:WeaponReload()
